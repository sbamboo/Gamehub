...
# Initializing a scoreboard connector with the storagetype being LegacyPantry (BuiltInPantryManager) and supply our pantryKey
...
scoreboard = scoreboardConnector(storageType="legacyPantry",key="<pantryKey>")
